<div id="form-pegawai">
    ...
    <div class="col-md-12 text-center">
        <hr style="width: 50%">
        <a href="{{ route('operator.verifikasi.dosens',[$data_dosen['slug']]) }}" class="btn btn-info btn-sm" style="color:white; cursor:pointer;"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
