                        ...
                        <tbody>
                            ...
                            @foreach ($pengajuans as $pengajuan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('operator.verifikasi.dosens.detail',[$pengajuan->dosen_slug,$pengajuan->cuti_dosen_id]) }}" class="btn btn-primary btn-sm text-white" style="cursor: pointer"><i class="fa fa-check-circle"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
