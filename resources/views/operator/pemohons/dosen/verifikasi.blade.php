...
<div class="modal fade modal" id="modalverifikasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action=" {{ route('admin.pemohons.dosen.verifikasi',[$dosen->id]) }} " method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-danger">Silahkan verifikasi ajuan cuti dosen berikut, harap berhati-hati, anda tidak dapat mengubah status jika sudah diverifikasi !!</div>
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control @error('status') is-invalid @enderror ">
                                    ...
                                    <option value="4">Tidak Setujui</option>
                                </select>
                                @error('status')
