		...
		<div id="particles-js">
            <div class="loginBox">
                ...
                @if ($message = Session::get('error'))
                    ...
                    @else
                    <h6>Form Login Sebagai Dosen</h6>
                ...
                <form method="post" action="{{ route('pegawai.login.submit') }}">
                    ...
                    <div class="form-group">
                        <p>Nip</p>
                        <input type="text" name="username" value="{{ old('username') }}" class="form-control @error('username') is-invalid @enderror" placeholder="masukan nip">
                        @error('username')
                ...
                <a href="" style="font-weight:normal; text-decoration:underline;" class="text-white">Login sebagai tendik</a>
            </div>
        </div>
    </body>
