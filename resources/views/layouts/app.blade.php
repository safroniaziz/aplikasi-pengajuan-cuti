...
<html lang="en">
  <head>
    ...
    <title>Pengajuan Cuti Pegawai | @yield('title') </title>
    ...
    <div class="container body">
      <div class="main_container" style="background:#013C62;">
        ...
        <div class="left_col scroll-view" style="background: #013C62 !important;">
            <div class="navbar nav_title" style="border-bottom: 1px white solid; margin:0; text-align:center; padding-bottom:5px 0px !important; background:#013C62;">
                <a href="index.html" class="site_title" style="font-weight:650;font-size:17px;" ><span>Aplikasi Pengajuan Cuti Dosen</span></a>
              </div>
