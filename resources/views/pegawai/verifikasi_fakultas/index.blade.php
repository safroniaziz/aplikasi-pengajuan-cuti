                    ...
                    @if ($message = Session::get('success'))
                        ...
                        @elseif ($message = Session::get('error'))
                            ...
                            <div class="alert alert-primary alert-block" id="keterangan">
                                <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Data yang ditampilkan dibawah ini adalah data permohonan pengajuan cuti yang diterima oleh operator fakultas dan menunggu verifikasi dari admin universitas!!
                            </div>
                    @endif
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($pengajuans as $pengajuan)
                                <tr>
                                    ...
                                    <td>
                                        @if ($pengajuan['pivot']->status == "3")
                                            <span class="badge badge-info"><i class="fa fa-check-circle"></i>&nbsp; Disetujui operator fakultas dan menunggu verifikasi admin universitas</span>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
