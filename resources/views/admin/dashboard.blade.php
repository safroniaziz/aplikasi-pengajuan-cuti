    ...
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div  style="text-align:center;">
                                    <strong>Selamat Datang <b class="text-uppercase text-primary">{{ Auth::user()->nm_user }}</b> di halaman <b class="text-uppercase">operator fakultas</b> aplikasi pengajuan surat cuti pegawai <a href="https://www.unib.ac.id" target="_blank">Universitas Bengkulu</a>. Silahkan ajukan keperluan cuti anda, untuk mempermudah proses pengajuan anda silahkan bacalah buku panduan jika disediakan !!</strong>
            ...
            <div class="col-md-9" style="margin-bottom:5px;">
                <section class="panel">
                    <header class="panel-heading" style="color: #ffffff;background-color: #074071;border-color: #fff000;border-image: none;border-style: solid solid none;border-width: 4px 0px 0;border-radius: 0;font-size: 14px;font-weight: 700;padding: 15px;">
                        <i class="fa fa-user"></i>&nbsp;Informasi Administrator Universitas Bengkulu
                        <span class="tools pull-right" style="margin-top:-5px;">
                            <a class="fa fa-chevron-down" href="javascript:;" style="float: left;margin-left: 3px;padding: 10px;text-decoration: none;"></a>
                            <a class="fa fa-times" href="javascript:;" style="float: left;margin-left: 3px;padding: 10px;text-decoration: none;"></a>
                        </span>
                            ...
                            <div class="col-md-12" id="table-data">
                                <table class="table">
                                    <tr>
                                        <th>Nama Lengkap</th>
                                        <td>:</td>
                                        <td class="text-uppercase">{{ $user->nm_user }}</td>
                                    </tr>
                                    <tr>
                                        <th>Email</th>
                                        <td>:</td>
