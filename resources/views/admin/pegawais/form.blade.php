<div id="form-pegawai">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" name="nm_pegawai" value="{{ old('nm_pegawai') ?? $pegawai->nm_pegawai }}" id="nm_pegawai" class="form-control @error('nm_pegawai') is-invalid @enderror">
        @error('nm_pegawai')
    ...
    <div class="form-group col-md-6">
        ...
        <input type="number" name="nip" value="{{ old('nip') ?? $pegawai->nip }}" id="nip" class="form-control @error('nip') is-invalid @enderror">
        @error('nip')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="form-group col-md-6">
        ...
        <select name="jenis_kelamin" value="{{ old('jenis_kelamin') }}" id="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror">
            ...
            <option value="0" {{ $pegawai->jenis_kelamin == "0" ? 'selected' : '' }}>Perempuan</option>
        </select>
        @error('jenis_kelamin')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" name="jabatan" value="{{ old('jabatan') ?? $pegawai->jabatan }}" id="jabatan" class="form-control @error('jabatan') is-invalid @enderror">
        @error('jabatan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" name="level_departemen" value="{{ old('level_departemen') ?? $pegawai->level_departemen }}" id="level_departemen" class="form-control @error('level_departemen') is-invalid @enderror">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" name="cabang" value="{{ old('cabang') ?? $pegawai->cabang }}" id="cabang" class="form-control @error('cabang') is-invalid @enderror">
        @error('cabang')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="form-group col-md-6">
        ...
        <select name="jenis_kepegawaian" value="{{ old('jenis_kepegawaian') }}" id="jenis_kepegawaian" class="form-control @error('jenis_kepegawaian') is-invalid @enderror">
            ...
            <option value="dosen" {{ $pegawai->jenis_kepegawaian == "dosen" ? 'selected' : '' }}> Dosen</option>
            <option value="tendik_pns "{{ $pegawai->jenis_kepegawaian == "tendik_pns" ? 'selected' : '' }}>Tendik PNS</option>
            <option value="tendik_non_pns" {{ $pegawai->jenis_kepegawaian == "tendik_non_pns" ? 'selected' : '' }}>Tendik Non PNS</option>
        </select>
