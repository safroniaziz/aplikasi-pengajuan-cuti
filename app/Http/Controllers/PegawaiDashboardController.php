...
class PegawaiDashboardController extends Controller
{
    public function index(Request $request, Dosen $dosen){
        ...
        $sisa               = 12 - count($dosen->cutis()->where('status','!=','1')->get());
        ...
        return view('pegawai/dashboard',compact('data_pegawai','jumlah','sisa','menunggu','diteruskan','tidak_diteruskan','diterima','ditolak'));
    }
}
